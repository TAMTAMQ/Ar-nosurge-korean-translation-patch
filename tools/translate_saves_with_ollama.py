...
ヴィオ=비오, フェリオン=펠리온, ネロ=네로, イオナサル=이오나사르,
クオンターヴ=퀀타브, シェルノトロン=셰르노트론, 天統姫=텐토우키, 天領沙羅=텐료사라,
インターディメンド=인터디멘드, 星詠台=성영대, アルノサージュ管=아르노사쥬관,
ヒュムノス=휴므노스, ヒュムネス=휴므네스, ヒュムネスフィア=휴므네스피어, 万寿沙羅=만쥬사라, 刻神楽/刻神楽=토키카구라, シェルン=셰룬, シェルノサージュ=셰르노사쥬, ジリリウム=질리리움,
クルトヒンメル=쿠르트힘멜, カソード=캐소드, イグジット=이그지트
""".strip()
...
원문의 전각 문장부호는 임의로 ASCII로 바꾸지 않는다. 특히 ～는 ～로 유지하고 ~로 바꾸지 않는다.
...
- 이름에 붙은 일본어 존칭·접미사는 반드시 살려서 옮긴다. さん=씨, 様/さま=님, 君/くん=군,
  ちゃん=쨩, 先輩=선배, 先生=선생님. 예: ねりこさん→네리코씨, 綾ちゃん→아야쨩.
- 씨/님/군/쨩은 이 프로젝트의 기존 규칙대로 이름에 붙여 쓴다.
