...
GLOSSARY = """
アルノサージュ/Ar nosurge=아르노사쥬, シェルノサージュ=셰르노사쥬,
デルタ=델타, キャス=캐스, イオン=이온, イオナサル=이오나사르,
アーシェス=아셰스, サーリ=살리, ネイ=네이, ジル=질, プリム=프림,
カノン=카논, シュレリア=슈레리아, タットリア=타토리아, レナルル=레나루루,
ジェノム=제놈, ジェノメトリクス=제노메트릭스, シャール=샤르,
詩魔法=시마법, 想い=마음, ソレイル=소레일, ラシェーラ=라셸라, フェリオン=펠리온,
クオンターヴ=퀀타브, シェルノトロン=셰르노트론, 天統姫=텐토우키, 天領沙羅=텐료사라,
インターディメンド=인터디멘드, 星詠台=성영대, アルノサージュ管=아르노사쥬관,
ヒュムノス=휴므노스, ヒュムネス=휴므네스, ヒュムネスフィア=휴므네스피어, 万寿沙羅=만쥬사라, 刻神楽/刻神楽=토키카구라, シェルン=셰룬, ジリリウム=질리리움, クルトヒンメル=쿠르트힘멜,
カソード=캐소드, イグジット=이그지트, セカイリンク=세카이 링크, TxBIOS=TxBIOS, バースト=버스트,
ハーモニクス=하모닉스, ガスト=가스트
""".strip()
...
원문의 의미, 인물 말투, 반말/존댓말의 격식 수준, 문장 완결성을 유지하되 공간이 부족하면 자연스럽게 축약한다.
원문에 없는 호칭을 새로 붙이지 않는다. さん=씨, 様/さま=님, 君/くん=군, ちゃん=쨩을 기본으로 하며 이름 뒤 접미 호칭은 붙여 쓴다.
...
원문의 전각 문장부호는 임의로 ASCII화하지 않는다. 특히 ～는 ～로 유지하고 ~로 바꾸지 않는다.
발화·감탄의 늘임 표시로 쓰인 원문의 ー는 번역에서도 ー로 유지하며 ～나 ~로 바꾸지 않는다.
단, シャール 같은 고유명사·일반 어휘 내부의 가타카나 장음부호는 용어집의 한국어 독음을 우선한다.
